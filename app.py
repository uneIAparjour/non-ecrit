...
STRINGS = {
    "fr": {
        ...
        "footer_model": 'Modèle <span class="name">{model}</span> via l\'<a href="https://ia.numerique.gouv.fr/outils-ia/albert-api/" target="_blank">API Albert</a> · hébergé sur <a href="https://render.com" target="_blank">Render</a> (<span class="name">Francfort, UE</span>)',
...
""".strip(),
    ...
    "en": {
        ...
        "footer_model": 'Model <span class="name">{model}</span> via the <a href="https://ia.numerique.gouv.fr/outils-ia/albert-api/" target="_blank">Albert API</a> · hosted on <a href="https://render.com" target="_blank">Render</a> (<span class="name">Frankfurt, EU</span>)',
